...
function Clock() {
    ...
    let formatStringDate = new Intl.DateTimeFormat("ru");

   let formatDay = new Intl.DateTimeFormat("en-US",
       {weekday: "long"
       });
   let formatMonth = new Intl.DateTimeFormat("en-US",{
       month: "long"
   });
    ...
    const stringDate = formatStringDate.format(date) || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
